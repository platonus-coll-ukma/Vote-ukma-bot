...
# ----------------- Config -----------------
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8339569755:AAFkXi4EJsSqBN0yGFz7ItffJnKfwenY35M")
ADMIN_TELEGRAM_ID = int(os.environ.get("ADMIN_TELEGRAM_ID", "8408918708") or 8408918708)
...
def tg_start(msg):
    ...
    is_admin = (msg.from_user.id == ADMIN_TELEGRAM_ID)
